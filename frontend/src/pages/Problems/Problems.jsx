...
function Problems() {
  return (
    <div class=" py-20 relative overflow-x-auto shadow-md sm:rounded-lg">
      <div class="flex items-center justify-between pb-4">
        <div>
          ...
          <div id="dropdownRadio" class="z-10 hidden w-48 bg-white divide-y divide-gray-100 rounded-lg shadow dark:bg-gray-700 dark:divide-gray-600 absolute inset-auto auto-0 m-0 transform translate-x-522.5 translate-y-3847.5" data-popper-reference-hidden="" data-popper-escaped="" data-popper-placement="top" >
