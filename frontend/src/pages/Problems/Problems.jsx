...
function Problems() {
  return (
    <div className=" py-20 relative overflow-x-auto shadow-md sm:rounded-lg">
      <div className="flex items-center justify-between pb-4">
        <div>
          ...
          <div id="dropdownRadio" className="z-10 hidden w-48 bg-white divide-y divide-gray-100 rounded-lg shadow dark:bg-gray-700 dark:divide-gray-600 absolute inset-auto auto-0 m-0 transform translate-x-522.5 translate-y-3847.5" data-popper-reference-hidden="" data-popper-escaped="" data-popper-placement="top" >
      ...
      <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
        ...
        <tbody>
          <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
            ...
            <td class="px-6 py-4">47.5%</td>
            <td class="px-6 py-4">Hard</td>
          ...
          <tr class="bg-white dark:bg-gray-800 hover:bg-gray-50 dark:hover:bg-gray-600">
            ...
            <td class="px-6 py-4"></td>
            <td class="px-6 py-4">32.8%</td>
            <td class="px-6 py-4">Mediun</td>
            <td class="px-6 py-4">Edit</td>
          </tr>
        </tbody>
      </table>
