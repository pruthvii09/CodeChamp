...
function Home() {
  return (
    <div className="py-20 flex flex-row bg-cyan-50">


      <div className="w-30rem my-0 mx-20 flex flex-col justify-center items-center ">
        <p className="text-6xl text-gray-600 font-semibold	pb-5">Start your coding journey today</p>
      ...
      <div className="">
        <img className="h-auto max-w-lg ml-auto "
        src="images/homeimg.jpg" alt="" />
      </div>
    </div>
  );
}
